package com.pattern.designpatterns.behavioral.memento.editors;


import com.pattern.designpatterns.behavioral.memento.commands.ColorCommand;
import com.pattern.designpatterns.behavioral.memento.commands.MoveCommand;
import com.pattern.designpatterns.behavioral.memento.shapes.Shape;
    ...
    private void attachMouseListeners() {
        ...
        MouseAdapter selector = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                com.pattern.designpatterns.behavioral.memento.shapes.Shape target = editor.getShapes().getChildAt(e.getX(), e.getY());
